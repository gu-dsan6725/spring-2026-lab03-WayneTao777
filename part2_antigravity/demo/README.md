...
| `03_xgboost_model.py` | XGBoost training with evaluation metrics |

Run them in order from the repo root:

```bash
uv run python part2_antigravity/demo/solved/01_eda.py
uv run python part2_antigravity/demo/solved/02_feature_engineering.py
uv run python part2_antigravity/demo/solved/03_xgboost_model.py
```
